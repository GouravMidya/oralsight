          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="relative border border-neutral-200 rounded-lg overflow-hidden dark:border-neutral-800" style={{ height: "60vh" }}>
              <div className="absolute inset-0 flex items-center justify-center overflow-auto">
                <div style={{ transform: `scale(${zoom / 100})`, transition: "transform 0.2s" }}>
                  <img src="/placeholder.svg" alt="Annotated X-ray" className="max-w-full h-auto" style={{ minWidth: "100%", minHeight: "100%" }} />
                  {/* Annotation overlay */}
                  <svg className="absolute inset-0 w-full h-full" style={{ pointerEvents: "none" }}>
                    <circle cx="50%" cy="30%" r="5%" fill="rgba(255, 0, 0, 0.5)" />
                    <rect x="20%" y="60%" width="10%" height="10%" fill="rgba(0, 255, 0, 0.5)" />
                    <path d="M 70 80 Q 90 50 110 80" stroke="blue" strokeWidth="2" fill="none" />
                  </svg>
                </div>
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button onClick={handleNextImage} size="icon" variant="outline" disabled={currentImageIndex === 2}>
          ...
          <div className="space-y-6">
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm mb-2">
                Predicted Class: <span className="font-bold">{result.predicted_class}</span>
              </p>
              <p className="text-sm mb-2">
